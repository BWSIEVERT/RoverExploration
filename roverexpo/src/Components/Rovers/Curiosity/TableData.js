...
import { curiosityAction } from "../../../Redux-Store/Actions";
...
const MainStyle = Styled.div`
  ...
  a {
    ...
    font-weight: 200;
    &:hover {
      border-bottom: 1px solid #F0583A;
    }
  }
  p {
    text-align: center;
...
const TableData = (props) => {
  ...
  return (
    ...
    <div className='Container'>
      <hr></hr>
        <h1>Curiosity Rover Data</h1>
        <p><a href='https://en.wikipedia.org/wiki/Curiosity_(rover)' target='_blank' rel='noreferrer'>Rover Wiki</a></p>
...
export default connect(mapStateToProps, { curiosityAction })(TableData);
